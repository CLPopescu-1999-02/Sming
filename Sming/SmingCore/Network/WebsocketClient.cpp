...
int WebsocketClient::verifyKey(HttpConnection& connection, HttpHeaders& headers)
{
	...
	const char *serverHashedKey = headers["Sec-WebSocket-Accept"].c_str();
	...
	headers.clear(); // we don't need the headers any longer
	state = WS_STATE_NORMAL;

	ws_parser_callbacks_t* parserSettings = new ws_parser_callbacks_t;
